...
export function VoiceSettingsModal({ 
  ...
  const handlePlayPreview = () => {
    ...
    // Play voice preview logic would go here
    setTimeout(() => {
      setIsPlaying(false);
    }, 3000);
  };
    ...
    >
      <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={styles.tabs}>
          ...
          >
            <Volume2 size={20} color={activeTab === 'output' ? colors.primary : colors.textSecondary} />
            <Text style={[
              styles.tabText, 
          ...
          >
            <Mic size={20} color={activeTab === 'input' ? colors.primary : colors.textSecondary} />
            <Text style={[
              styles.tabText, 
              { color: activeTab === 'input' ? colors.primary : colors.textSecondary }
            ]}>
              Voice Input
            </Text>
          </TouchableOpacity>
                ...
                {voiceProfiles.length > 0 ? (
                  voiceProfiles.map((profile) => (
                    ...
                    >
                      ...
                      <View style={styles.voiceProfileActions}>
                        <TouchableOpacity 
              ...
              <View style={styles.section}>
                ...
                <View style={[styles.infoBox, { backgroundColor: colors.primary + '10' }]}>
                  <Text style={[styles.infoText, { color: colors.textSecondary }]}>
                    Voice input is processed securely and never stored permanently. Your privacy is our priority.
                  </Text>
                </View>
              </View>
            </>
